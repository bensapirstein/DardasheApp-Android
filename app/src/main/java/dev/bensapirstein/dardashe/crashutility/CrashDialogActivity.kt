...
package dev.bensapirstein.dardashe.crashutility
...
import dev.bensapirstein.dardashe.app.prefs.AppPrefs
import dev.bensapirstein.dardashe.app.prefs.florisPreferenceModel
import dev.bensapirstein.dardashe.databinding.CrashDialogBinding
...
class CrashDialogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        errorReport.apply {
            ...
            appendLine("- FlorisBoard Version: ${dev.bensapirstein.dardashe.BuildConfig.VERSION_NAME} (${dev.bensapirstein.dardashe.BuildConfig.VERSION_CODE})")
