...
package dev.bensapirstein.dardashe.app.ui.settings.about
...
import dev.bensapirstein.dardashe.common.launchUrl
...
fun AboutScreen() = FlorisScreen(title = stringRes(R.string.about__title)) {
    ...
    val appVersion = "${dev.bensapirstein.dardashe.BuildConfig.VERSION_NAME} (${dev.bensapirstein.dardashe.BuildConfig.VERSION_CODE})"
    ...
    Preference(
        ...
        onClick = { launchUrl(context, R.string.florisboard__changelog_url, "version" to dev.bensapirstein.dardashe.BuildConfig.VERSION_NAME) },
    )
    Preference(
