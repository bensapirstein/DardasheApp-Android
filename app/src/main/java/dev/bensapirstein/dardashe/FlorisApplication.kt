...
package dev.bensapirstein.dardashe
...
import dev.bensapirstein.dardashe.common.NativeStr
import dev.bensapirstein.dardashe.common.toNativeStr
import dev.bensapirstein.dardashe.crashutility.CrashUtility
import dev.bensapirstein.dardashe.debug.Flog
...
import dev.bensapirstein.dardashe.ime.core.SubtypeManager
import dev.bensapirstein.dardashe.ime.dictionary.DictionaryManager
import dev.bensapirstein.dardashe.ime.spelling.SpellingManager
import dev.bensapirstein.dardashe.ime.spelling.SpellingService
import dev.bensapirstein.dardashe.ime.theme.ThemeManager
import dev.bensapirstein.dardashe.res.AssetManager
import dev.bensapirstein.dardashe.res.ext.ExtensionManager
...
class FlorisApplication : JetPrefApplication() {
    companion object {
        ...
        init {
            try {
                System.loadLibrary("dardashe-native")
            } catch (_: Exception) {
            }
        }
    }
    ...
    override fun onCreate() {
        ...
        try {
            Flog.install(
                context = this,
                isFloggingEnabled = dev.bensapirstein.dardashe.BuildConfig.DEBUG,
