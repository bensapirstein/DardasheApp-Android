...
package dev.bensapirstein.dardashe.ime.text

import android.view.KeyEvent
import android.widget.Toast
import androidx.core.text.isDigitsOnly
import dev.bensapirstein.dardashe.BuildConfig
import dev.bensapirstein.dardashe.R
import dev.bensapirstein.dardashe.app.prefs.florisPreferenceModel
import dev.bensapirstein.dardashe.assetManager
import dev.bensapirstein.dardashe.databinding.FlorisboardBinding
import dev.bensapirstein.dardashe.debug.LogTopic
import dev.bensapirstein.dardashe.debug.flogError
import dev.bensapirstein.dardashe.debug.flogInfo
import dev.bensapirstein.dardashe.ime.clip.provider.ClipboardItem
import dev.bensapirstein.dardashe.ime.core.EditorInstance
import dev.bensapirstein.dardashe.ime.core.FlorisBoard
import dev.bensapirstein.dardashe.ime.core.InputEventDispatcher
import dev.bensapirstein.dardashe.ime.core.InputKeyEvent
import dev.bensapirstein.dardashe.ime.core.InputKeyEventReceiver
import dev.bensapirstein.dardashe.ime.core.Preferences
import dev.bensapirstein.dardashe.ime.core.Subtype
import dev.bensapirstein.dardashe.ime.core.TextProcessor
import dev.bensapirstein.dardashe.ime.dictionary.DictionaryManager
import dev.bensapirstein.dardashe.ime.keyboard.ComputingEvaluator
import dev.bensapirstein.dardashe.ime.keyboard.ImeOptions
import dev.bensapirstein.dardashe.ime.keyboard.InputAttributes
import dev.bensapirstein.dardashe.ime.keyboard.KeyData
import dev.bensapirstein.dardashe.ime.keyboard.Keyboard
import dev.bensapirstein.dardashe.ime.keyboard.KeyboardState
import dev.bensapirstein.dardashe.ime.keyboard.updateKeyboardState
import dev.bensapirstein.dardashe.ime.text.gestures.GlideTypingManager
import dev.bensapirstein.dardashe.ime.text.gestures.SwipeAction
import dev.bensapirstein.dardashe.ime.text.key.CurrencySet
import dev.bensapirstein.dardashe.ime.text.key.KeyCode
import dev.bensapirstein.dardashe.ime.text.key.KeyType
import dev.bensapirstein.dardashe.ime.text.key.KeyVariation
import dev.bensapirstein.dardashe.ime.text.key.UtilityKeyAction
import dev.bensapirstein.dardashe.ime.text.keyboard.KeyboardMode
import dev.bensapirstein.dardashe.ime.text.keyboard.TextKeyData
import dev.bensapirstein.dardashe.ime.text.keyboard.TextKeyboardCache
import dev.bensapirstein.dardashe.ime.text.keyboard.TextKeyboardIconSet
import dev.bensapirstein.dardashe.ime.text.keyboard.TextKeyboardView
import dev.bensapirstein.dardashe.ime.text.layout.LayoutManager
import dev.bensapirstein.dardashe.ime.text.smartbar.SmartbarView
import dev.bensapirstein.dardashe.res.FlorisRef
    ...
    override fun onWordHistoryChanged(
        ...
        if (activeState.isComposingEnabled && !inputEventDispatcher.isPressed(KeyCode.DELETE) && !isGlidePostEffect) {
            launch(Dispatchers.Default) {
                ...
                if (dev.bensapirstein.dardashe.BuildConfig.DEBUG) {
